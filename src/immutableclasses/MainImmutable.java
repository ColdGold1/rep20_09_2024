...
import immutable.external.LivingPerson;
import immutable.external.PersonOfInterest;

public class MainImmutable {
    public static void main(String[] args) {

        PersonImmutable jane = new PersonImmutable("Jane", "01/01/1930");
        PersonImmutable joe = new PersonImmutable("Joe", "02/02/1932)");
        PersonImmutable jim = new PersonImmutable("Jim", "03/03/1934");

        PersonImmutable[] johnKids = {jane, joe, jim};
        PersonImmutable john = new PersonImmutable("John","05/05/1900",johnKids);
        System.out.println(john);

        PersonImmutable[] kids = john.getKids();
        kids[0] = jim;
        kids[1] = new PersonImmutable("Kim","06/06/1900",kids);
        System.out.println(john);

        kids[1] = new PersonImmutable("Ann","04/04/1936",kids);
        System.out.println(john);
